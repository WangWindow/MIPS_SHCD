...
#
# Script generated by Vivado on Sun Dec 29 20:18:12 +0800 2024
...
#
# Usage        : MyVIO.sh
#                MyVIO.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MyVIO.sh [-reset_run]
#                MyVIO.sh [-reset_log]
#                MyVIO.sh [-help]
#
...
#                script (type 'MyVIO.sh -help' for more information).
#
...
# script info
echo -e "MyVIO.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MyVIO.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl/verilog" +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl/verilog" +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MyVIO xil_defaultlib.glbl -o MyVIO_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MyVIO_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MyVIO_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MyVIO_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MyVIO.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MyVIO.sh [-help]\n\
Usage: MyVIO.sh [-step]\n\
Usage: MyVIO.sh [-lib_map_path]\n\
Usage: MyVIO.sh [-reset_run]\n\
Usage: MyVIO.sh [-reset_log]\n\
Usage: MyVIO.sh [-keep_index]\n\
Usage: MyVIO.sh [-noclean_files]\n\n\
