...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl/verilog" +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl/verilog" +incdir+"../../../../MyCPU.gen/sources_1/ip/MyVIO/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.MyVIO xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.MyVIO -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log MyVIO_sc.so .tmp_log xcelium_lib waves.shm c.obj)
