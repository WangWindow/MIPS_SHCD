...
#
# Script generated by Vivado on Sun Dec 29 19:49:30 +0800 2024
...
#
# Usage        : MyRam.sh
#                MyRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MyRam.sh [-reset_run]
#                MyRam.sh [-reset_log]
#                MyRam.sh [-help]
#
...
# script info
echo -e "MyRam.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MyRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MyRam xil_defaultlib.MyRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MyRam -key {Behavioral:sim_1:Functional:MyRam} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/App/Dev/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MyRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MyRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MyRam.sh [-help]\n\
Usage: MyRam.sh [-step]\n\
Usage: MyRam.sh [-lib_map_path]\n\
Usage: MyRam.sh [-reset_run]\n\
Usage: MyRam.sh [-reset_log]\n\
Usage: MyRam.sh [-keep_index]\n\
Usage: MyRam.sh [-noclean_files]\n\n\
