...
#
# Script generated by Vivado on Mon Dec 30 21:46:43 +0800 2024
...
#
# Usage        : MyRom.sh
#                MyRom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MyRom.sh [-reset_run]
#                MyRom.sh [-reset_log]
#                MyRom.sh [-help]
#
...
# script info
echo -e "MyRom.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MyRom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MyRom xil_defaultlib.MyRom xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MyRom.wdb xsim.dir libdpi.so)
...
Usage: MyRom.sh [-reset_log]\n\
Usage: MyRom.sh [-keep_index]\n\
